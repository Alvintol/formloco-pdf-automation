...
(async () => {
  ...
  if (formController.emergencyResponsePlanning) {
    ...
    await page.waitForXPath(
      '//*[@id="cdk-overlay-28"]/mat-bottom-sheet-container/app-bottom-sheet-worksite-safety-inspection/div[2]/button[1]'
    );
    await clickHandler(
      '//*[@id="cdk-overlay-28"]/mat-bottom-sheet-container/app-bottom-sheet-worksite-safety-inspection/div[2]/button[1]'
    );
    ...
    await page.type("[formcontrolname=comment]", "**TEST**");
    await clickHandler(
      '//*[@id="mat-dialog-26"]/app-comment/div[2]/form/div[2]/div/button'
    );
    await page.click("[formcontrolname=DateCorrectiveActionToBeCompleted]");
  ...
  if (formController.confinedSpaceEntry) {
    ...
    await page.type("[formcontrolname=comment]", "**TEST**");
    await clickHandler(
      '//*[@id="mat-dialog-40"]/app-comment/div[2]/form/div[2]/div/button'
    );
    await page.click("[formcontrolname=DateCorrectiveActionToBeCompleted]");
